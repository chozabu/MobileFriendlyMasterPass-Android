...
/**
 *  * Created by chozabu on 09/11/15.
 *  * based on http://ldapchai.googlecode.com/svn-history/r72/trunk/src/com/novell/ldapchai/util/SCrypt.java
 *
...
public class SCrypt {
    ...
    public static boolean check(String passwd, String hashed) {
        try {
            ...
            byte[] salt = Base64.encode(parts[3].getBytes(), Base64.NO_WRAP);
            byte[] derived0 = Base64.encode(parts[3].getBytes(), Base64.NO_WRAP);
